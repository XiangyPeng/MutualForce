...
class Detector3DTemplate(nn.Module):
    def __init__(self, model_cfg, num_class, dataset):
        ...
        self.module_topology = [
            ...
            'backbone_2d' ,'bev_shape_head','dense_head',  'point_head', 'roi_head' # 
        ]
    ...
    # 这个是根据BSH-BEV的角度上来说的
    def build_bev_shape_head(self, model_info_dict):
        if self.model_cfg.get('DENSE_BEV_HEAD', None) is None:
            return None, model_info_dict
        # model_cfg = self.model_cfg.DENSE_BEV_HEAD
        # dense_head_module = dense_heads.__all__[model_cfg.DENSE_BEV_HEAD.NAME](
        #     model_cfg=model_cfg.DENSE_BEV_HEAD,
        #     input_channels=model_info_dict['num_bev_features'],
        #     num_class=self.num_class if not model_cfg.DENSE_BEV_HEAD.CLASS_AGNOSTIC else 1,
        ...
        #     return None, model_info_dict
        dense_head_module = dense_heads.__all__[self.model_cfg.DENSE_BEV_HEAD.NAME](
            model_cfg=self.model_cfg.DENSE_BEV_HEAD,
            input_channels=model_info_dict['num_bev_features'],
            num_class=self.num_class if not self.model_cfg.DENSE_BEV_HEAD.CLASS_AGNOSTIC else 1,
            class_names=self.class_names,
            grid_size=model_info_dict['grid_size'],
            point_cloud_range=model_info_dict['point_cloud_range'],
