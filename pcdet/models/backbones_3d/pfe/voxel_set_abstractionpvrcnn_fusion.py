...
class VoxelSetAbstraction_PVRCNN_head(nn.Module):
    def __init__(self, model_cfg, voxel_size, point_cloud_range, num_bev_features=None,
        ...
        self.vsa_point_feature_fusion = nn.Sequential(
            nn.Linear(160, self.model_cfg.NUM_OUTPUT_FEATURES, bias=False),
    ...
    def get_sampled_points(self, batch_dict):
        ...
        if self.model_cfg.POINT_SOURCE == 'raw_points':
            src_points = batch_dict['lidar_points'][:, 1:4]
            batch_indices = batch_dict['lidar_points'][:, 0].long()
    ...
    def forward(self, batch_dict):
        ...
        if 'bev' in self.model_cfg.FEATURES_SOURCE:
            point_bev_features = self.interpolate_from_bev_features(
                ...
                # bev_stride=batch_dict['lidar_spatial_features']
                 bev_stride=1
            )
        ...
        if 'raw_points' in self.model_cfg.FEATURES_SOURCE:
            raw_points = batch_dict['lidar_points']
            xyz = raw_points[:, 1:4]
